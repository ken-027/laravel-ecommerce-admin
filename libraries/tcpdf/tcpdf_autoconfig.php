...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'JustConvert');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'JustConvert');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'JustConvert');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "by JustConvert");
}
