          ...
          <div class="block block-signin-up clearfix">
             <nav>
                <div class="nav nav-tabs" id="signin-up-tab" role="tablist">
                   <a class="nav-item nav-link tab-nav active" id="signin-tab"  data-toggle="tab" href="#signin" role="tab" aria-controls="signin" aria-selected="true">I HAVE AN ACCOUNT</a>
                   <a class="nav-item nav-link tab-nav" id="sign-up-tab" data-toggle="tab" href="#signup" role="tab" aria-controls="signup" aria-selected="false">CREATE A NEW ACCOUNT</a>
                </div>
             </nav>
             <div class="tab-content clearfix" id="signin-up-tabContent">             
                <div class="tab-pane fade show active clearfix" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                   <div class="inner clearfix">
                     ...
                     @endif
                      <div class="checkout-block clearfix">
                         ...
                         <div class="p-5">
                            <form class="clearfix bv-form" action="{{ route('user.login') }}" method="post" id="login_form" novalidate="novalidate">
                              @csrf
                               <div class="form-group">
                                  <label for="username">EMAIL</label>
                                  <input type="text" class="form-control" id="username" name="email" placeholder="" autocomplete="off" value="{{ isset($email) ? $email : '' }}" data-bv-field="username">
                                  <small data-bv-validator="notEmpty" data-bv-validator-for="username" class="help-block" style="display: none;">Please enter an email address</small><small data-bv-validator="emailAddress" data-bv-validator-for="username" class="help-block" style="display: none;">Please enter a valid email address</small>
                               </div>
                               <div class="form-group">
                                  <label for="password">PASSWORD</label>
                                  <input type="password" class="form-control" id="password" name="password" placeholder="" autocomplete="off" data-bv-field="password">
                                  <small data-bv-validator="notEmpty" data-bv-validator-for="password" class="help-block" style="display: none;">Please enter your password.</small>
                               </div>
                               <div class="clearfix"></div>
                               <button type="submit" class="btn btn-primary btn-lg float-left">Login</button>
                               <input type="hidden" name="submit_form" id="submit_form">
                               <input type="hidden" value="">
                            </form>
                            <a href="{{ route('account.forgot-password') }}" class="link-forgot-pass">Forgot Your Password?</a>
                         </div>
                      </div>
                   </div>
                </div>
                <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="sign-up-tab">
                   <div class="inner clearfix">
                      <div class="checkout-block signup clearfix">
                         <h3>New Account</h3>
                         <form class="clearfix bv-form" action="{{ route('user.signup') }}" method="post" id="signup_form" novalidate="novalidate">
                            @csrf
                            <div class="form-group">
                               <label for="exampleInputEmail1">FIRST NAME AND LAST NAME</label>
                               <input type="text" class="form-control" name="name" id="name" placeholder="" data-bv-field="name">
                               <small data-bv-validator="stringLength" data-bv-validator-for="name" class="help-block" style="display: none;">This value is not valid</small><small data-bv-validator="notEmpty" data-bv-validator-for="name" class="help-block" style="display: none;">Please enter your first name and last name</small>
                            </div>
                            <div class="form-group">
                               <label for="exampleInputEmail1">EMAIL</label>
                               <input type="text" class="form-control" name="email" id="email" placeholder="" autocomplete="off" data-bv-field="email">
                               <small data-bv-validator="notEmpty" data-bv-validator-for="email" class="help-block" style="display: none;">Please enter an email address</small><small data-bv-validator="emailAddress" data-bv-validator-for="email" class="help-block" style="display: none;">Please enter a valid email address</small>
                            </div>
                            <div class="form-group">
                               ...
                               <small data-bv-validator="notEmpty" data-bv-validator-for="password" class="help-block" style="display: none;">Please enter your password.</small><small data-bv-validator="identical" data-bv-validator-for="password" class="help-block" style="display: none;">Password and confirm password values not matched.</small>
                            </div>
                            <div class="form-group">
                               ...
                               <small data-bv-validator="notEmpty" data-bv-validator-for="password_confirmation" class="help-block" style="display: none;">Please confirm your password.</small><small data-bv-validator="identical" data-bv-validator-for="confirm_password" class="help-block" style="display: none;">Password and confirm password values not matched.</small>
                            </div>
                            <div class="clearfix"></div>
                            <p>The information below will be used for shipping and payment only.</p>
                            <div class="clearfix"></div>
                            <div class="form-group">
                               <label for="exampleInputEmail1">ADDRESS 1</label>
                               <input type="text" name="address" id="address" placeholder="Address Line1" class="form-control" autocomplete="off" data-bv-field="address">
                               <small data-bv-validator="notEmpty" data-bv-validator-for="address" class="help-block" style="display: none;">Please fill address line 1.</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-row">
                               <div class="form-group col-md-7">
                                  ...
                                  <input type="text" name="city" id="city" placeholder="City" class="form-control" autocomplete="off" data-bv-field="city">
                                  <small data-bv-validator="notEmpty" data-bv-validator-for="city" class="help-block" style="display: none;">Please enter city.</small>
                               </div>
                               <div class="form-group col-md-5">
                                  <label for="exampleInputEmail1">STATE</label>
                                  <input type="text" name="state" id="state" placeholder="State" class="form-control" autocomplete="off" data-bv-field="state">
                                  <small data-bv-validator="notEmpty" data-bv-validator-for="state" class="help-block" style="display: none;">Please enter state.</small>
                               </div>
                            </div>
                            <div class="form-row">
                               <div class="form-group col-md-5">
                                  <label for="exampleInputEmail1">ZIP CODE</label>
                                  <input type="text" name="postcode" id="postcode" placeholder="Post Code" class="form-control" autocomplete="off" data-bv-field="postcode">
                                  <small data-bv-validator="notEmpty" data-bv-validator-for="postcode" class="help-block" style="display: none;">Please enter post code.</small>
                               </div>
                               <div class="form-group col-md-7">
                                  <label for="exampleInputEmail1">PHONE</label>
                                  <div class="intl-tel-input allow-dropdown">
                                     <div class="flag-container">
                                        <div class="selected-flag" tabindex="0" title="Philippines: +63">
                                        ...
                                        <ul class="country-list hide">
                                           ...
                                           <li class="country" data-dial-code="93" data-country-code="af">
                                              ...
                                              <span class="country-name">Afghanistan (&#x202B;افغانستان&#x202C;&lrm;)</span><span class="dial-code">+93</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="213" data-country-code="dz">
                                              ...
                                              <span class="country-name">Algeria (&#x202B;الجزائر&#x202C;&lrm;)</span><span class="dial-code">+213</span>
                                           </li>
                                           <li class="country" data-dial-code="1684" data-country-code="as">
                                              <div class="flag-box">
                                                 <div class="iti-flag as"></div>
                                              </div>
                                              <span class="country-name">American Samoa</span><span class="dial-code">+1684</span>
                                           </li>
                                           <li class="country" data-dial-code="376" data-country-code="ad">
                                              <div class="flag-box">
                                                 <div class="iti-flag ad"></div>
                                              </div>
                                              <span class="country-name">Andorra</span><span class="dial-code">+376</span>
                                           </li>
                                           <li class="country" data-dial-code="244" data-country-code="ao">
                                              <div class="flag-box">
                                                 <div class="iti-flag ao"></div>
                                              </div>
                                              <span class="country-name">Angola</span><span class="dial-code">+244</span>
                                           </li>
                                           <li class="country" data-dial-code="1264" data-country-code="ai">
                                              <div class="flag-box">
                                                 <div class="iti-flag ai"></div>
                                              </div>
                                              <span class="country-name">Anguilla</span><span class="dial-code">+1264</span>
                                           </li>
                                           <li class="country" data-dial-code="1268" data-country-code="ag">
                                              <div class="flag-box">
                                                 <div class="iti-flag ag"></div>
                                              </div>
                                              <span class="country-name">Antigua and Barbuda</span><span class="dial-code">+1268</span>
                                           </li>
                                           <li class="country" data-dial-code="54" data-country-code="ar">
                                              <div class="flag-box">
                                                 <div class="iti-flag ar"></div>
                                              </div>
                                              <span class="country-name">Argentina</span><span class="dial-code">+54</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="297" data-country-code="aw">
                                              ...
                                              <span class="country-name">Aruba</span><span class="dial-code">+297</span>
                                           </li>
                                           <li class="country" data-dial-code="61" data-country-code="au">
                                              <div class="flag-box">
                                                 <div class="iti-flag au"></div>
                                              </div>
                                              <span class="country-name">Australia</span><span class="dial-code">+61</span>
                                           </li>
                                           <li class="country" data-dial-code="43" data-country-code="at">
                                              <div class="flag-box">
                                                 <div class="iti-flag at"></div>
                                              </div>
                                              <span class="country-name">Austria (Österreich)</span><span class="dial-code">+43</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="1242" data-country-code="bs">
                                              ...
                                              <span class="country-name">Bahamas</span><span class="dial-code">+1242</span>
                                           </li>
                                           <li class="country" data-dial-code="973" data-country-code="bh">
                                              <div class="flag-box">
                                                 <div class="iti-flag bh"></div>
                                              </div>
                                              <span class="country-name">Bahrain (&#x202B;البحرين&#x202C;&lrm;)</span><span class="dial-code">+973</span>
                                           </li>
                                           <li class="country" data-dial-code="880" data-country-code="bd">
                                              <div class="flag-box">
                                                 <div class="iti-flag bd"></div>
                                              </div>
                                              <span class="country-name">Bangladesh (বাংলাদেশ)</span><span class="dial-code">+880</span>
                                           </li>
                                           <li class="country" data-dial-code="1246" data-country-code="bb">
                                              <div class="flag-box">
                                                 <div class="iti-flag bb"></div>
                                              </div>
                                              <span class="country-name">Barbados</span><span class="dial-code">+1246</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="254" data-country-code="ke">
                                              ...
                                              <span class="country-name">Kenya</span><span class="dial-code">+254</span>
                                           </li>
                                           <li class="country" data-dial-code="686" data-country-code="ki">
                                              <div class="flag-box">
                                                 <div class="iti-flag ki"></div>
                                              </div>
                                              <span class="country-name">Kiribati</span><span class="dial-code">+686</span>
                                           </li>
                                           <li class="country" data-dial-code="383" data-country-code="xk">
                                              <div class="flag-box">
                                                 <div class="iti-flag xk"></div>
                                              </div>
                                              <span class="country-name">Kosovo</span><span class="dial-code">+383</span>
                                           </li>
                                           <li class="country" data-dial-code="965" data-country-code="kw">
                                              <div class="flag-box">
                                                 <div class="iti-flag kw"></div>
                                              </div>
                                              <span class="country-name">Kuwait (&#x202B;الكويت&#x202C;&lrm;)</span><span class="dial-code">+965</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="856" data-country-code="la">
                                              ...
                                              <span class="country-name">Laos (ລາວ)</span><span class="dial-code">+856</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="961" data-country-code="lb">
                                              ...
                                              <span class="country-name">Lebanon (&#x202B;لبنان&#x202C;&lrm;)</span><span class="dial-code">+961</span>
                                           </li>
                                           <li class="country" data-dial-code="266" data-country-code="ls">
                                              <div class="flag-box">
                                                 <div class="iti-flag ls"></div>
                                              </div>
                                              <span class="country-name">Lesotho</span><span class="dial-code">+266</span>
                                           </li>
                                           <li class="country" data-dial-code="231" data-country-code="lr">
                                              <div class="flag-box">
                                                 <div class="iti-flag lr"></div>
                                              </div>
                                              <span class="country-name">Liberia</span><span class="dial-code">+231</span>
                                           </li>
                                           <li class="country" data-dial-code="218" data-country-code="ly">
                                              <div class="flag-box">
                                                 <div class="iti-flag ly"></div>
                                              </div>
                                              <span class="country-name">Libya (&#x202B;ليبيا&#x202C;&lrm;)</span><span class="dial-code">+218</span>
                                           </li>
                                           <li class="country" data-dial-code="423" data-country-code="li">
                                              <div class="flag-box">
                                                 <div class="iti-flag li"></div>
                                              </div>
                                              <span class="country-name">Liechtenstein</span><span class="dial-code">+423</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="1649" data-country-code="tc">
                                              ...
                                              <span class="country-name">Turks and Caicos Islands</span><span class="dial-code">+1649</span>
                                           </li>
                                           <li class="country" data-dial-code="688" data-country-code="tv">
                                              <div class="flag-box">
                                                 <div class="iti-flag tv"></div>
                                              </div>
                                              <span class="country-name">Tuvalu</span><span class="dial-code">+688</span>
                                           </li>
                                           <li class="country" data-dial-code="1340" data-country-code="vi">
                                              <div class="flag-box">
                                                 <div class="iti-flag vi"></div>
                                              </div>
                                              <span class="country-name">U.S. Virgin Islands</span><span class="dial-code">+1340</span>
                                           </li>
                                           <li class="country" data-dial-code="256" data-country-code="ug">
                                              <div class="flag-box">
                                                 <div class="iti-flag ug"></div>
                                              </div>
                                              <span class="country-name">Uganda</span><span class="dial-code">+256</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="971" data-country-code="ae">
                                              ...
                                              <span class="country-name">United Arab Emirates (&#x202B;الإمارات العربية المتحدة&#x202C;&lrm;)</span><span class="dial-code">+971</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="598" data-country-code="uy">
                                              ...
                                              <span class="country-name">Uruguay</span><span class="dial-code">+598</span>
                                           </li>
                                           ...
                                           <li class="country" data-dial-code="678" data-country-code="vu">
                                              ...
                                              <span class="country-name">Vanuatu</span><span class="dial-code">+678</span>
                                           </li>
                                           <li class="country" data-dial-code="39" data-country-code="va">
                                              <div class="flag-box">
                                                 <div class="iti-flag va"></div>
                                              </div>
                                              <span class="country-name">Vatican City (Città del Vaticano)</span><span class="dial-code">+39</span>
                                           </li>
                                           <li class="country" data-dial-code="58" data-country-code="ve">
                                              <div class="flag-box">
                                                 <div class="iti-flag ve"></div>
                                              </div>
                                              <span class="country-name">Venezuela</span><span class="dial-code">+58</span>
                                           </li>
                                           <li class="country" data-dial-code="84" data-country-code="vn">
                                              <div class="flag-box">
                                                 <div class="iti-flag vn"></div>
                                              </div>
                                              <span class="country-name">Vietnam (Việt Nam)</span><span class="dial-code">+84</span>
                                           </li>
                                           <li class="country" data-dial-code="681" data-country-code="wf">
                                              <div class="flag-box">
                                                 <div class="iti-flag wf"></div>
                                              </div>
                                              <span class="country-name">Wallis and Futuna (Wallis-et-Futuna)</span><span class="dial-code">+681</span>
                                           </li>
                                           <li class="country" data-dial-code="212" data-country-code="eh">
                                              <div class="flag-box">
                                                 <div class="iti-flag eh"></div>
                                              </div>
                                              <span class="country-name">Western Sahara (&#x202B;الصحراء الغربية&#x202C;&lrm;)</span><span class="dial-code">+212</span>
                                           </li>
                                           <li class="country" data-dial-code="967" data-country-code="ye">
                                              <div class="flag-box">
                                                 <div class="iti-flag ye"></div>
                                              </div>
                                              <span class="country-name">Yemen (&#x202B;اليمن&#x202C;&lrm;)</span><span class="dial-code">+967</span>
                                           </li>
                                     ...
                                     <input type="tel" id="phone" name="phone" class="form-control" placeholder="0905 123 4567" autocomplete="off" data-bv-field="cell_phone">
                                  </div>
                                  {{-- <input type="hidden" name="phone" id="phone"> --}}
                                  <small data-bv-validator="callback" data-bv-validator-for="phone" class="help-block" style="display: none;">Please enter valid phone number</small>
                               </div>
                            </div>
                            <div class="clearfix"></div>
                            <button id="register" type="submit" class="btn btn-primary btn-lg float-left">CREATE ACCOUNT</button>
                            <input type="hidden" name="submit_form" id="submit_form">
                            <input type="hidden" value="">
                         </form>
                      </div>
