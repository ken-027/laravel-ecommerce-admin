    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header row align-items-center sub-menu">
                <div class="col">
                    <span><i class="bi bi-layout-split me-2"></i></span><span class="h6">Bulk Orders</span>
                </div>
            ...
            <div class="table-responsive">
                <table id="formBulkOrderTable" class="table table-bordered table-striped data-table" style="width: 100%; min-width: 800px" data-table="{{ $table_name }}" data-title='Bulk Order'>
                    <thead class="">
                        <tr>
